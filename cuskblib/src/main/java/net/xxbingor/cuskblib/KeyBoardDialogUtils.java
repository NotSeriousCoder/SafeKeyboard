...
//				view.getBackground().setAlpha(68);
            ...
            popWindow.setOnDismissListener(new DialogInterface.OnDismissListener() {
                ...
                public void onDismiss(DialogInterface dialog) {
                    ...
                    keyboardUtil.clearEditTextFocus();
                }
            });
            initView();
    ...
    public void show(final EditText editText, String title) {
...
//        hideSystemSofeKeyboard(editText);
        popWindow.show();
        keyboardUtil.showKeyboard(editText, title);
    }
